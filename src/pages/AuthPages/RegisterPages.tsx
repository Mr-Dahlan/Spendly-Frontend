  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="container flex flex-col gap-4 mt-10 pl-20">
          <div className="gap-2 w-full pr-30">
            <h1 className="text-3xl font-bold">
              Start your journey to financial freedom
            </h1>
          </div>
          <div className="double-box grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
            <div className="box bg-[var(--bg)] py-4 rounded-2xl hover:scale-105 delay-100 shadow-2xl border-1 border-gray-100 pl-2">
              <Shield
                className="mb-4"
                fill="var(--blue-primary)"
                strokeWidth={0}
              />
              <h1 className="font-bold mb-2">Secure Assets</h1>
              <p className="mb-4 text-sm">SECURITY GUARANTEED</p>
            </div>

            <div className="box bg-[var(--bg)] py-4 rounded-2xl hover:scale-105 delay-100 shadow-2xl border-1 border-gray-100 pl-2">
              <TrendingUp className="text-[var(--blue-primary)] mb-4" />
              <h1 className="font-bold mb-2">Smart Analytics</h1>
              <p className="mb-4 text-sm">REAL-TIME ANALYTICS</p>
            </div>
          </div>
      ...
      {/* ── RIGHT PANEL ── */}
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-16 pb-2">
